...
function ConfirmDialog({ name, onConfirm, onCancel, theme }) {
  return (
    <div style={{
      ...
      <div style={{
        background: theme.card, border: '1px solid #ef4444', borderRadius: 14,
        padding: '32px 36px', maxWidth: 360, width: '90%', textAlign: 'center',
        fontFamily: "'JetBrains Mono', monospace",
      }}>
        <div style={{ fontSize: 36, marginBottom: 12 }}>⚠️</div>
        <h3 style={{ color: theme.text, margin: '0 0 8px', fontSize: 18 }}>Delete Member?</h3>
        <p style={{ color: theme.textDim, margin: '0 0 24px', fontSize: 14, lineHeight: 1.5 }}>
...
// ── Dashboard rocker switch for theme toggle ──
  ...
  return (
    <button
      ...
      style={{
        ...
        background: isDark ? '#0a0a14' : '#eae6dc',
    ...
    >
      <span style={{
        ...
        boxShadow: isDark
          ? '0 0 8px rgba(16,185,129,0.7), 0 1px 2px rgba(0,0,0,0.3)'
          : '0 0 8px rgba(245,158,11,0.5), 0 1px 2px rgba(0,0,0,0.15)',
...
function LoginScreen({ onSuccess, theme, themeName, onToggleTheme }) {
  ...
  return (
    <div style={{
      ...
      fontFamily: "'JetBrains Mono', monospace", background: theme.bg, padding: 20,
      ...
      <form onSubmit={handleSubmit} style={{
        ...
        <div style={{ fontSize: 11, letterSpacing: 4, color: theme.accent, marginBottom: 6, textTransform: 'uppercase' }}>
          Membership System
        </div>
        ...
        <button type="submit" disabled={loading} style={{
          ...btnStyle(theme.accent, theme.bg), width: '100%', opacity: loading ? 0.6 : 1,
          display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8,
        }}>
          {loading && (
            <span style={{
              width: 14, height: 14, border: `2px solid ${theme.bg}`,
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '40px 20px', fontFamily: "'JetBrains Mono', monospace" }}>
        ...
        <div style={{ marginBottom: 28, position: 'relative' }}>
          ...
          <input
            ...
            style={inputStyle(theme, { width: '100%', paddingLeft: 48, fontSize: 16 })}
          />
          {searchQuery && (
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 16, flexWrap: 'wrap' }}>
                    ...
                    <div style={{ flex: '1 1 200px', minWidth: 0 }}>
                      ...
                      <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', marginBottom: 8 }}>
                        {member.car_model && (
                          <span style={{ fontSize: 12, color: theme.textDim }}>🚗 {member.car_model}</span>
                        )}
